/*! angular-app - v0.0.1-SNAPSHOT - 2015-04-22
...
angular.module('services.i18nMessages', []).constant('I18N.MESSAGES', {
...
angular.module('services.localizedMessages', ['services.i18nMessages']).factory('localizedMessages', ['$interpolate', 'I18N.MESSAGES', function ($interpolate, i18nmessages) {
...
angular.module("admin/projects/projects-edit.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("admin/projects/projects-edit.tpl.html",
    ...
    "                    </thead>\n" +
    "                    <tbody>\n" +
    "                    <tr ng-repeat=\"id in project.teamMembers\">\n" +
    "                        <td>{{usersLookup[id].getFullName()}}</td>\n" +
    "                        <td>\n" +
    "                            <button class=\"btn btn-small\" ng-click=\"removeTeamMember(id)\">Remove</button>\n" +
    "                        </td>\n" +
    "                    </tr>\n" +
    "                    <tr>\n" +
...
angular.module("projects/sprints/tasks/tasks-edit.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projects/sprints/tasks/tasks-edit.tpl.html",
    ...
    "                <select name=\"ProductBacklogId\" class=\"span10\" ng-model=\"task.ProductBacklogId\" ng-options=\"backlogItem.$id() as backlogItem.name for backlogItem in sprintBacklogItems\" required></select>\n" +
    "                <label>Description</label>\n" +
    ...
    "                <select name=\"UserId\" ng-model=\"task.UserId\" class=\"span10\" ng-options=\"teamMember.$id() as teamMember.getFullName() for teamMember in teamMembers\"></select>\n" +
    "            </div>\n" +
    "      </div>\n" +
    "      <hr>\n" +
    "      <crud-buttons></crud-buttons>\n" +
...
angular.module("projectsinfo/projects-show.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("projectsinfo/projects-show.tpl.html",
    "<div class=\"well\">\n" +
    "    <legend>{{ project.name }}</legend>\n" +
    "    <div class=\"row-fluid\">\n" +
    "        <div class=\"span6\">\n" +
    "            <span class=\"span10\">{{ project.desc }}</span>\n" +
    "        </div>\n" +
    "        <div class=\"span6\" ng-controller=\"TeamMembersController\">\n" +
    "            <label><strong>Product Owner</strong></label>\n" +
    "            <span>{{ project.productOwnerFullName() }}</span>\n" +
    "            <label><strong>Scrum Master</strong></label>\n" +
    "            <span>{{ project.scrumMasterFullName() }}</span>\n" +
    "            <label><strong>Development Team</strong></label>\n" +
    "            <table class=\"table table-bordered table-condensed table-striped table-hover\">\n" +
    "                <tbody>\n" +
    ...
    "        <hr>\n" +
    "        <div class=\"span12\">\n" +
    "            <button type=\"button\" class=\"btn btn-primary save\" ng-click=\"back()\" >Back</button>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
